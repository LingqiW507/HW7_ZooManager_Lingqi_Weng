...
namespace ZooManager
{
    public static class Game
    {
        ...
        static public void ReplaceAnimal(Animal animal, Animal animal1)
        {
            animalZones[animal.location.y][animal.location.x].occupant = animal1;
        }
        ...
        static public void AddAnimalToHolding(string animalType)
        {
            ...
            if (animalType == "raptor") holdingPen.occupant = new Raptor("Cruel");
            if (animalType == "chick") holdingPen.occupant = new Chick("Little");
